...
o.setCoreMaterialId(k,0,k)}o.getCoreSkeleton().calculateBoundingBoxes(o);o=new Cal3D.CalModel(o);for(k=0;k<e.meshes.length;k++)o.attachMesh(k);o.setMaterialSet(0);if(c&&c.onload){k={};k.model=o;k.path=e.path;k.scale=e.scale;for(var n in e.userdefined)k[n]=e.userdefined[n];c.onload(k,b)}},m={};m.onload=function(o,k){g.animations[k]=o;--f==0&&h()};m.onerror=function(o,k){c&&c.onerror&&c.onerror(o,k)};var l={};l.onload=function(o,k){g.meshes[k]=o;--f==0&&h()};l.onerror=function(o,k){c&&c.onerror&&c.onerror(o,
k)};var p={};p.onload=function(o,k){g.materials[k]=o;--f==0&&h()};p.onerror=function(o,k){c&&c.onerror&&c.onerror(o,k)};var q={};q.onload=function(o,k){g.skeletons[k]=o;for(k=0;k<e.animations.length;k++)Cal3D.CalLoader.loadCoreAnimationFromFile(e.path+e.animations[k],o,m);for(k=0;k<e.meshes.length;k++)Cal3D.CalLoader.loadCoreMeshFromFile(e.path+e.meshes[k],l);for(k=0;k<e.materials.length;k++)Cal3D.CalLoader.loadCoreMaterialFromFile(e.path+e.materials[k],p);--f==0&&h()};q.onerror=function(o,k){c&&
c.onerror&&c.onerror(o,k)};Cal3D.CalLoader.loadCoreSkeletonFromFile(e.path+e.skeletons[0],q)}}};d.onerror=function(){Cal3D.CalError.setLastError(Cal3D.CalError.Code.FILE_NOT_FOUND,"loader.js",0,b);c&&c.onerror&&c.onerror(Cal3D.CalError.Code.FILE_NOT_FOUND,b)};d.onprogress=function(e){c&&c.onprogress&&c.onprogress(e.position/e.totalSize,b)};d.send()};
...
Cal3D.CalLoader.parseConfigFile=function(b){var c=/^\s*(\w+)\s*=\s*([^:*?"<>|\r\n]+)\s*$/,d={path:"",scale:1,skeletons:[],animations:[],meshes:[],materials:[],userdefined:{}};b=b.split("\n");for(var e=0;e<b.length;e++){var f=c.exec(b[e]);if(f){var g=f[1];f=f[2];switch(g){case "path":if(d.path==""){d.path=f;g=d.path.charAt(d.path.length-1);if(g!="/"&&g!="\\")d.path+="/"}break;case "scale":d.scale=parseFloat(f);break;case "skeleton":d.skeletons.push(f);break;case "animation":d.animations.push(f);break;
case "mesh":d.meshes.push(f);break;case "material":d.materials.push(f);break;default:g in d.userdefined||(d.userdefined[g]=[]);d.userdefined[g].push(f);break}}}return d};
